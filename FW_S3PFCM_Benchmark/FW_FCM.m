function [Cluster_elem,M,Z]=FW_FCM(X,M,k,t_max,beta_memory,N,fuzzy_degree,d,q,landa, balance_parm,a_coefficient,b_coefficient,T_pow)
%
%[Cluster_elem,M,Z]=FW_FCM(X,M,k,t_max,beta_memory,N,fuzzy_degree,d,q,landa, balance_parm,a_coefficient,b_coefficient,T_pow)
%
%Function Inputs
%===============
...
T=ones(N,k)/k;  %initial possiblistic memberships
...
fprintf('\nStart of fuzzy C-means clustering method based on feature-weight learning iterations\n');
fprintf('----------------------------------\n\n');
...
while 1
    ...
    O_F=object_fun(N,d,k,Cluster_elem,landa,M,fuzzy_degree,Z,q,X,gama,T,a_coefficient,b_coefficient,T_pow);
